...
class ProductPage(BasePage):
    ...
    def should_be_button(self):
        self.is_element_present(*ProductPageLocators.BUTTON_ADD_TO_BASKET), 'Button "add to basker" is not presented'

    def should_be_elements_before_add(self):
        self.is_element_present(*ProductPageLocators.PRODUCT_NAME), "Product name is not presented"
        self.is_element_present(*ProductPageLocators.PRODUCT_VALUE), "Product value is not presented"

    def should_be_elements_after_add(self):
        self.is_element_present(*ProductPageLocators.PRODUCT_NAME_IN_CART), "Product name in cart is not presented"
        self.is_element_present(*ProductPageLocators.CART_VALUE), "Cart value is not presented"
